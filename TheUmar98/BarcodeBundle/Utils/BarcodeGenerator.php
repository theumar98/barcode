 ...
 */
namespace TheUmar98\BarcodeBundle\Utils;
use TheUmar98\BarcodeBundle\Utils\BarcodeType;
use TheUmar98\BarcodeBundle\Generator\CINColor;
use TheUmar98\BarcodeBundle\Generator\CINDrawing;
use TheUmar98\BarcodeBundle\Generator\CINFontFile;
...
class BarcodeGenerator extends BarcodeType {
    ...
    private function _getCode(){
        ...
        //try{
            ...
            $codeClass = "\\TheUmar98\\BarcodeBundle\\Generator\\".$this->barcodeType;
            $code = new $codeClass();
            if($this->scale){
